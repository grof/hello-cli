...
@fgroleau/grofcli/1.3.0-beta.3 linux-x64 node-v16.14.0
$ hello --help [COMMAND]
USAGE
  $ hello COMMAND
...
...
_See code: [src/commands/hello.ts](https://github.com/grof/hello-cli/blob/v1.3.0-beta.3/src/commands/hello.ts)_
